...
export default class MultiSelect extends Component {
  ...
  _renderItems = () => {
    const { items, fontFamily, uniqueKey, selectedItems ,onMomentumScrollEnd , onTouchStart , onScrollEndDrag , onMomentumScrollBegin , onTouchEnd , onScrollBeginDrag} = this.props;
